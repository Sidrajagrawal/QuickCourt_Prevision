...
const Home = () => {
    ...
    // Function to handle clicking on a venue card
    const handleViewDetails = (venue) => {
        navigate('/venue-details', { state: { venue } }); // Pass the venue object in the state
    };
                ...
                <div className="hidden md:grid md:grid-cols-4 gap-8 mb-12">
                    {venues.map((venue, index) => (
                        <VenueCard
                            key={index}
                            venue={venue}
                            onView={handleViewDetails} // Pass the handler function
